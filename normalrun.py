...
OPENROUTER_API_KEY= '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'
...
async def run_agent(message: str, username: str, chat_id: str, google_search: str, deep_google_search: str,current_time) -> None:
    try:
        ...
        async with MultiMCPTools(["npx -y @openbnb/mcp-server-airbnb --ignore-robots-txt  --port 3000"]) as mcp_tools:
            agent = Agent(
                model=OpenRouter(id="deepseek/deepseek-chat-v3-0324:free",api_key="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"),
